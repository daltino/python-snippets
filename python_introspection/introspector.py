...
from python_collections import sorted_set
...
def print_table(rows_of_columns, *headers):
    ...
    if len(headers) != num_columns:
        raise TypeError("Expected {} headers arguments, "
...
def dump(obj):
    ...
    print("Attributes")
    print("==========")
    all_attr_names = sorted_set.SortedSet(dir(obj))
    method_names = sorted_set.SortedSet(
